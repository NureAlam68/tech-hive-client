...
const FeaturedProducts = () => {
  ...
  return (
    <section className="mt-10 md:mt-[60px] lg:mt-[80px] 2xl:mt-[100px] max-w-[1600px] mx-auto">
      <h2 className="text-3xl lg:text-4xl font-bold text-center dark:text-gray-200">
        Featured Products
      </h2>
      <p className="mt-4 text-lg text-gray-600 dark:text-gray-400 text-center">
        Featured Products are top-rated and specially curated tech innovations.
      </p>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-4 md:px-6 lg:px-8 mt-6 md:mt-8 lg:mt-10">
        {products.map((product) => (
          <div
            key={product._id}
            className="border p-4 rounded-lg dark:bg-black dark:border dark:border-gray-600 overflow-hidden transform hover:scale-105 transition-transform duration-300"
          >
            <img
            ...
            />
            <h3 className="text-lg font-semibold mt-2 cursor-pointer dark:text-gray-200">
              {product.productName}
            </h3>
