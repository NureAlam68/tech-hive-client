...
const Navbar = () => {
  ...
  return (
    <>
      <div className="navbar bg-base-100 shadow-sm fixed top-0 z-50 bg-opacity-95 backdrop-blur-sm xl:px-20 2xl:px-[162px] max-w-[1920px] mx-auto">
      <div className="navbar-start">
        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="menu-horizontal px-1 gap-6">
            <li>
              <NavLink to="/" className="text-base hover:text-primary hover:bg-base-200 font-medium">
                Home
              </NavLink>
            </li>
            <li>
