        ...
        <div className="relative max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
          <div className="text-center">
            ...
            <p className="max-w-2xl mx-auto text-xl text-gray-300 leading-relaxed">
              ...
              innovations. Join our community of tech enthusiasts, developers,
              and entrepreneurs.
            </p>
          </div>
        </div>
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 mb-12 dark:bg-gray-900 border dark:border dark:border-gray-600">
          ...
          <p className="text-lg text-gray-700 leading-relaxed dark:text-gray-300">
            At TechHive, we&apos;re building a thriving community where
            innovation meets collaboration. Our platform empowers users to
            share, discover, and discuss the most exciting tech products,
            creating a dynamic ecosystem for the future of technology.
          </p>
        </div>
          ...
          {[
            {
              ...
              description:
                "Discover everything from AI tools to cutting-edge software",
            },
            {
              icon: <Users className="w-8 h-8" />,
              title: "Vibrant Community",
              description:
                "Connect with fellow tech enthusiasts and innovators",
            },
            {
            ...
            },
            {
              ...
              description: "Gain valuable insights through detailed statistics",
            },
          ].map((feature, index) => (
            <div
              key={index}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <p>
                  Product Submission & Interaction with seamless upvoting and
                  reviewing
                </p>
              </div>
              <div className="flex items-start">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 dark:bg-gray-900 border dark:border dark:border-gray-600">
          ...
          <div className="flex flex-wrap gap-6 items-center justify-center md:justify-start">
            <a
              href="#"
              className="flex items-center space-x-2 text-gray-600 hover:text-blue-600 transition-colors dark:text-blue-600"
            >
            ...
            <a
              href="mailto:contact@techhive.com"
              className="flex items-center space-x-2 text-gray-600 hover:text-blue-600 transition-colors dark:text-blue-600"
            >
