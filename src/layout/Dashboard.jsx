...
const Dashboard = () => {
  ...
  const navLinkClasses = (isActive) =>
    `flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${
      isActive
        ...
        : "text-slate-600 hover:bg-blue-50 dark:hover:bg-blue-900"
    }`;
  ...
  return (
    <div className="flex h-screen dark:bg-black">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:static inset-y-0 left-0 w-72 bg-white border-r border-slate-100 dark:border-gray-700 shadow-lg transform transition-transform duration-300 z-30 lg:transform-none ${
        ...
        <div className="flex flex-col h-full dark:bg-blue-950">
          ...
          <div className="p-6 border-b border-slate-100 dark:border-gray-700">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-slate-900 dark:text-gray-200">Dashboard</h1>
                <p className="text-sm text-slate-500 dark:text-gray-400">Role: {role}</p>
              </div>
            </div>
          </div>
          ...
          <nav className="flex-1 overflow-y-auto p-4">
            <div className="space-y-1">
              ...
              <NavLink
                ...
                onClick={() => setIsSidebarOpen(false)}
              >
                <Home size={20} className="dark:text-gray-200"/>
      ...
      <main className="flex-1 flex flex-col min-h-0">
        ...
        {/* Content Area */}
        <div className="flex-1 overflow-y-auto p-4 lg:p-8 dark:bg-slate-950">
          <Outlet />
        </div>
      </main>
    </div>
